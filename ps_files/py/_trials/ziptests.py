#! /usr/bin/env python3
from _header import *
for fn_name in fn_names_lst:
	fn = globals()[fn_name]
<<<<<<< HEAD
	zipinfo=ps_zip.getZipInfo(fn)
	print ("test "+fn_name+":", shcolar.fg.brightGreen+fn+" zipinfo: "+str(zipinfo)+" zipinfotype: "+str(type(zipinfo))+shcolar.fg.reset)
print ("fn_lst:\n", "\n".join(fn_lst))
=======
	zipinfo_dict=ps_zip.getZipInfo(fn)
	print ("test "+fn_name+":", shcolar.fg.brightGreen+fn+" zipinfo: "+str(zipinfo_dict)+" zipinfotype: "+str(type(zipinfo_dict))+shcolar.fg.reset)
	print ("fn list:\n" , "\n".join(fn_lst))
>>>>>>> 84760707f1f6ff995a85755825f9b5534fe239e8
